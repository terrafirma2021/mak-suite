...
`makxd` is a Rust library for controlling MAKXD USB HID interceptor devices. These are small USB dongles (CH343 VID:PID `1A86:55D3` or CH340 VID:PID `1A86:7523`) that sit between a mouse and a host PC, allowing programmatic mouse control via serial commands.
