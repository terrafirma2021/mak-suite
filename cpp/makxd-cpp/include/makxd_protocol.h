...
namespace makxd {
    ...
    struct DeviceRoute {
        ...
        [[nodiscard]] bool hasMouse() const noexcept {
            return (routeMask & 0x01u) != 0u;
        }

        [[nodiscard]] bool hasKeyboard() const noexcept {
            return (routeMask & 0x02u) != 0u;
        }

        [[nodiscard]] bool hasController() const noexcept {
            return (routeMask & 0x04u) != 0u;
        }
