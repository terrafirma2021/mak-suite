...
namespace Makxd
{
    ...
    public readonly struct ControllerStreamState
    {
        public ControllerStreamState(uint buttons, byte hat, ushort lt,
            ushort rt, short x, short y, short rx, short ry, short z, short rz)
        {
            Buttons = buttons;
            Hat = hat;
            Lt = lt;
    ...
    public static class StreamProtocol
    {
        ...
        public static bool TryDecodeController(StreamInputRecord record,
            out ControllerStreamState state)
        {
            state = default(ControllerStreamState);
            ...
            state = new ControllerStreamState(
                ...
                (short)ReadU16(record.Values, 15),
                (short)ReadU16(record.Values, 17),
                (short)ReadU16(record.Values, 19));
            return true;
        }
